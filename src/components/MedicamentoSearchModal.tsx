...
export default function BuscarMedicamentoView() {
  ...
  return (
    <div className={`min-h-screen bg-slate-50 text-slate-800 pb-32 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] ${animationClass}`}>
